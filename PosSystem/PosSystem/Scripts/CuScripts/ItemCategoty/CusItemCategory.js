...
$(document).ready(function () {
    ...
    var sl = 0;
    dataTable = $("#ItemCategoryDataTable").DataTable({
        "ajax": {
            "url": sub + "ItemCategory/GetItemCategoryData",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
        ...
        "language": {
            "emptyTable": "No Data Found Please Click on the <b> Add Item Category</b> Button."
        }
...
function PopupFormCategory(a) { 
    ...
    var url = sub + "ItemCategory/OpenItemCategoryForm/" + a;
    var formDiv = $('<div/>');
    $.get(url,
        function (rData) {
            formDiv.html(rData);
...
function CategoryDeleteForm(a) {
    var url = sub + "ItemCategory/DeleteCategory";
    var parm = { id: a };
    alert("Are You Sure!......");
    $.post(url,
        parm,
